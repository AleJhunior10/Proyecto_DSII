...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-06-2021 a las 16:06:48
...
INSERT INTO `cliente` (`idcliente`, `ci_nit`, `nombre`, `telefono`, `direccion`, `usuario_id`) VALUES
(1, 3017018, 'Tomas Villca', 76949636, 'Las Encinas', 1),
(2, 18927371, 'Fabiana Mattos', 76254122, 'Valle Hermoso', 2),
(3, 198281282, 'Sabastian Gonzales', 763434343, 'Valle Hermoso', 2);
...
(1, 1234567890, 'La Caleta', 'Bar Restaurante Cafeteria', 44762779, 'lacaleta.com', 'IC Norte Hipodromo', '0.13');
...
(1, '2021-06-02 01:14:29', 1, 1, '39.00', 1),
(2, '2021-06-02 01:27:56', 2, 2, '65.00', 1),
(3, '2021-06-02 09:17:48', 1, 1, '64.00', 1),
(4, '2021-06-02 09:26:54', 2, 3, '58.00', 1);
...
(1, 'Croissant', 1, '7.00', 27, 1),
(2, 'Empanada de queso', 1, '6.00', 14, 1),
(3, 'Donas', 1, '8.00', 27, 1),
(4, 'Submarinos', 2, '20.00', 2, 1),
(5, 'Chocolate Blanco', 2, '45.00', 6, 1),
(6, 'Cafe', 3, '20.00', 9, 1),
(7, 'Sandwich jamon y queso', 1, '20.00', 10, 1),
(8, 'Sandwich de pollo', 1, '20.00', 9, 1),
(9, 'Empanadas de jamon', 4, '7.00', 20, 1);
...
(1, 'La Caleta', 'Isabel Reinaga', 76543210, 'Av. Beigin', 1),
(2, 'Chocolates Para Ti', 'Rodrigo Gomez', 78653412, 'Simon Lopez', 1),
(3, 'Irupana', 'Fabiana Meneses', 65425162, 'America', 1),
(4, 'La casera', 'Rodrigo Meneses', 76452423, 'Simon Lopez', 1);
...
(1, 'Jhunior Mollo', 'jhunior@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1),
(2, 'Sebastian Mollo', 'sebas@gmail.com', 'sebas', '0d40d9aea2b3b5a149dc34495fff0a0a', 2),
(3, 'Misael Marquez', 'misa@gmail.com', 'misael', 'f1ed7e55d61c2f1af0ae4a28141e54bb', 2);
