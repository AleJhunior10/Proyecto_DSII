<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$pdf->Cell(15, 5, "------------------------------------------------------------------------", 0, 1, 'L');
		$pdf->Ln();
		$pdf->image("img/astro.jpg", 31, 5, 20, 20, 'JPG');
		...
		$pdf->Cell(40, 5, "Numero de CI / Nit:", 0, 0, 'L');
		$pdf->SetFont('Arial', '', 7);
		$pdf->Cell(40, 5, utf8_decode($result_cliente['ci_nit']), 0, 1, 'L');
		$pdf->SetFont('Arial', 'B', 7);
		...
		$pdf->Cell(76, 5, 'Total: ' . number_format($result_venta['totalfactura'], 2, '.', ',') . ' Bs.', 0, 1, 'R');
		$pdf->Cell(15, 5, "----------------------------------------------------------------", 0, 1, 'L');
		$pdf->Ln();
		$pdf->SetFont('Arial', '', 7);
