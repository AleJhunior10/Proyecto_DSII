                                ...
                                <div class="card-body">
                                    <form method="post" name="form_new_cliente_venta" id="form_new_cliente_venta">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col align-self-center" id="div_registro_cliente" style="display: none; margin-top: 15px;">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-4">
                                    ...
                                    <div id="acciones_venta" class="form-group">
                                        <a href="#" class="btn btn-danger" id="btn_anular_venta"><i class="fas fa-times"></i> Anular</a>
                                        <a href="#" class="btn btn-primary" id="btn_facturar_venta"><i class="fas fa-save"></i> Registrar</a>
                                    </div>
                                </div>
                            </div>
