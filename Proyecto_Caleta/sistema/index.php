			...
			<div class="card border-left-primary shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Personal</div>
		...
		<div class="col-lg-6">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						<label>Cargo: <strong><?php echo $_SESSION['rol_name']; ?></strong></label>
					</div>
					<div class="form-group">
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-primary btnChangePass">Guardar Datos</button>
							</div>
